...
// Note: product-catalogue downloads are stored in their own dedicated table
// (catalog_leads, see lib/catalogLeadsDb.js), but "product_catalog" is a valid
// crm_leads source too so the shared ingest accepts + labels it rather than
// coercing it to "api" if it ever arrives here.
export const LEAD_STATUSES = ["new", "contacted", "qualified", "won", "lost"];
export const LEAD_SOURCES = ["manual", "contact", "careers", "api", "product_catalog"];
