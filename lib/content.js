...
export const nav = [
  ...
  { label: "Who We Are", href: "/about" },
  {
    ...
    href: "/assembly-lines",
    children: [
      { label: "Low Voltage", href: "/low-voltage" },
      { label: "Medium Voltage", href: "/medium-voltage" },
    ],
  },
  {
    label: "Supplies",
    href: "/supplies",
    children: [
      { label: "Dry Type Transformers", href: "/products/dry-type-transformers" },
      { label: "Oil Type Transformers", href: "/products/oil-type-transformers" },
    ],
  },
...
export const heroStats = [
  { value: 2012, suffix: "", label: "Founded in" },
...
export const projects = [
  { name: "Al Mehwar Hospital", type: "Healthcare Infrastructure", img: "/img/proj-almehwar.jpg" },
  { name: "Sodic Vilette", type: "Residential Development", img: "/img/proj-sodic-vilette.jpg" },
  { name: "Acrow Formwork Technology", type: "Industrial Manufacturing", img: "/img/proj-acrow.jpg" },
  { name: "Sodic June", type: "Mixed-Use Development", img: "/img/proj-sodic-june.jpg" },
  { name: "Mountain View", type: "Residential Development", img: "/img/proj-mountain-view.jpg" },
  { name: "Zed Park", type: "Urban Development", img: "/img/proj-zed-park.jpg" },
];
...
export const productLines = [
  ...
  },
  {
    ...
    title: "Supplies",
    href: "/supplies",
    img: "/img/line-supplies.jpg",
    blurb:
      "A full range of high-quality distribution transformers from leading partners like Hitachi Energy and El Sewedy — oil-filled and dry-type, for indoor and outdoor use.",
    specs: [
...
export const milestones = [
  { year: "2012", title: "Kick-off", img: "/img/ms-2012.jpg", body: "Founded with a vision for reliable, innovative electrical solutions." },
  { year: "2015", title: "Infrastructure", img: "/img/ms-2015.jpg", body: "Expanded capabilities into advanced infrastructure solutions and home automation." },
  { year: "2017", title: "LVP Assembly", img: "/img/ms-2017.jpg", body: "Introduced advanced low-voltage panel (LVP) assembly." },
  { year: "2018", title: "Certified Success", img: "/img/ms-2018.jpg", body: "Achieved certification of LVP panel building." },
  { year: "2021", title: "Assembly of RMUs", img: "/img/ms-2021.jpg", body: "Began assembly of Ring Main Units for power distribution solutions." },
  { year: "2022", title: "CSS Integration", img: "/img/ms-2022.jpg", body: "Integration of Compact Secondary Substation (CSS) systems." },
  { year: "2024", title: "Smart RMUs", img: "/img/ms-2024.jpg", body: "Introduction of SMART RMUs." },
  { year: "2025", title: "SWG Schneider MCSET 24KV", img: "/img/ms-2025.jpg", body: "Assembly of Schneider MCset switchgear rated 24KV." },
];

export const values = [
  { title: "Customer Focus", n: "01" },
  { title: "Continuous Innovation", n: "02" },
  { title: "Collaboration", n: "03" },
  { title: "Excellence", n: "04" },
  { title: "Ownership", n: "05" },
];
...
export const powerlineEffect = {
  before: "/img/effect-before.jpg",
  after: "/img/effect-after.jpg",
};

export const memorial = {
  name: "Engineer Hassan El-Sayed",
  img: "/img/memorial.png",
...
export const customers = Array.from({ length: 10 }, (_, i) =>
  i === 1 ? "/img/cust-elsewedy.png" : `/img/cust-${i + 1}.png`
);
...
export const lowVoltage = {
  ...
  products: [
    ...
    { name: "Minicenter", href: "/products/minicenter-abb", desc: "For residential and commercial segments — different designs up to 24 modules." },
...
export const mediumVoltage = {
  ...
  products: [
    ...
    { name: "P-RAL", href: "/products/pral24", desc: "Air-insulated 12/24 KV Ring Main Unit based on ABB NAL/NALF load break switches." },
    { name: "P-SEC", href: "/products/psec", desc: "SF6 12/24 KV Ring Main Unit using ABB and Murge SF6 load break switches." },
...
export const supplies = {
  title: "Supplies",
  intro:
    "Powerline's Supplies collection features a full range of high-quality distribution transformers from leading partners like Hitachi Energy and El Sewedy — oil-filled and dry-type options for indoor and outdoor use across utility, industrial and commercial sectors.",
  products: [
...
export const products = {
  ...
  plp: {
    title: "PLP",
    line: "Low Voltage",
    img: "/img/prod-plp.png",
    gallery: ["/img/prod-plp.png", "/img/prod-plp-2.png"],
    lead:
      "PLP is our local modular type-tested low-voltage distribution panel designed for power distribution and motor control in commercial, industrial, and infrastructure applications.",
    specs: [
  ...
  "pro-e": {
    title: "PRO-E",
    line: "Low Voltage",
    img: "/img/prod-pro-e.jpg",
    gallery: ["/img/prod-pro-e.jpg", "/img/prod-pro-e-2.jpg"],
    lead:
  ...
  "minicenter-abb": {
    title: "Minicenter",
    line: "Low Voltage",
    img: "/img/prod-minicenter.png",
    gallery: ["/img/prod-minicenter.png", "/img/prod-minicenter-2.jpg"],
    lead:
  ...
  unikit: {
    title: "UniKIT",
    line: "Low Voltage",
    img: "/img/prod-unikit.png",
    gallery: ["/img/prod-unikit.png", "/img/prod-unikit-2.png"],
    lead:
  ...
  "sr-basic": {
    title: "SR Basic",
    line: "Low Voltage",
    img: "/img/prod-sr-basic.jpg",
    gallery: [
      "/img/prod-sr-basic.jpg",
      "/img/prod-sr-basic-2.jpg",
      "/img/prod-sr-basic-3.jpg",
      "/img/prod-sr-basic-4.png",
    ],
    lead:
  ...
  pral24: {
    title: "P-RAL",
    line: "Medium Voltage",
    img: "/img/prod-pral.jpg",
    gallery: ["/img/prod-pral.jpg", "/img/prod-pral-2.png"],
    lead:
      "P-RAL 12KV & 24KV Air Ring Main Unit — a compact switchgear solution for secondary power distribution networks, based on ABB load break switches NAL/NALF.",
    specs: [
      { k: "Voltage class", v: "12 / 24 kV" },
  ...
  psec: {
    title: "P-SEC",
    line: "Medium Voltage",
    img: "/img/prod-psec.png",
    gallery: ["/img/prod-psec.png", "/img/prod-psec-2.png", "/img/prod-psec-3.jpg"],
    lead:
      "P-SEC 12KV & 24KV SF6 Ring Main Unit — a compact switchgear solution for secondary power distribution networks, using ABB SF6 and Murge SF6 load break switches.",
    specs: [
      { k: "Voltage class", v: "12 / 24 kV" },
      { k: "Insulation", v: "SF6" },
