...
export const projects = [
  ...
  { name: "Dejoya 1", type: "Residential", img: "/img/proj-dejoya.webp" },
  { name: "East Town", type: "Residential", img: "/img/proj-east-town.webp" },
  { name: "Dorrat El Karz 2", type: "Residential", img: "/img/proj-dorrat-elkarz.webp" },
];
...
export const productLines = [
  ...
  },
  {
    ...
    img: "/img/line-secondary.jpg",
    blurb:
      "Secondary distribution switchgear — ring main units and compact secondary substations up to 24kV, built with global technology partners.",
    specs: [
      { value: 24, suffix: "kV", label: "Voltage class" },
...
export const primarySwitchgear = {
  title: "Primary Switchgear",
  intro:
    "Primary medium-voltage switchgear for main distribution and incoming feeders — Schneider MCset switchgear assembled by Powerline up to 24kV, engineered to IEC standards.",
  products: [
...
export const secondarySwitchgear = {
  title: "Secondary Switchgear",
  intro:
    "Secondary distribution switchgear — ring main units and compact secondary substations up to 24kV, engineered to international standards with global technology partners including ABB, Lucy Electric and Schneider Electric.",
  products: [
    ...
    { name: "Aegis Plus 12 & 24 KV", href: "/products/aegis-plus-12-24-kv", desc: "Aegis Plus — Powerline under license of Lucy Electric." },
  ],
};
...
export const products = {
  ...
  "switchgear-mcset": {
    ...
    gallery: ["/img/prod-mcset.webp", "/img/mcset-cert.png"],
    lead:
  ...
  "aegis-plus-12-24-kv": {
    title: "Aegis Plus 12 & 24 KV",
    line: "Secondary Switchgear",
    img: "/img/prod-gis-rmu.webp",
    gallery: ["/img/prod-gis-rmu.webp", "/img/aegis-cert.png"],
    lead:
  ...
  "pro-e": {
    ...
    gallery: ["/img/prod-pro-e.webp", "/img/prod-pro-e-2.webp", "/img/abb-panel-builder.png"],
    lead:
  ...
  "minicenter": {
    ...
    gallery: ["/img/prod-minicenter.webp", "/img/prod-minicenter-2.webp", "/img/abb-panel-builder.png"],
    lead:
  ...
  unikit: {
    ...
    gallery: ["/img/prod-unikit.webp", "/img/prod-unikit-2.webp", "/img/abb-panel-builder.png"],
    lead:
  ...
  pral: {
    ...
    gallery: ["/img/prod-pral.webp", "/img/prod-pral-2.webp", "/img/pral-cert.jpeg"],
    badge: "/img/type-tested.webp",
    lead:
  ...
  psec: {
    ...
    gallery: [
      ...
      "/img/psec-cert-abb.png",
      "/img/psec-cert-murge.png",
    ],
    badge: "/img/type-tested.webp",
    lead:
