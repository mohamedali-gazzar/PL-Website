...
export const instrumentTransformers = {
  ...
  products: [
    { name: "Current & Voltage Transformers", href: "/products/instrument-transformers", desc: "Cast-resin CT & VT (12/24 kV) for MV metering and protection — fully encapsulated, maintenance-free, tested to IEC 61869." },
  ],
};
...
export const products = {
  ...
  "instrument-transformers": {
    ...
    gallery: [
      "/img/prod-instrument-transformers.webp",
      "/img/it-ct-lzzb.webp",
    ...
    badge: "/img/type-tested.webp",
    lead:
      "Powerline's instrument transformers deliver accurate current and voltage measurement for energy metering and protection in medium voltage. Primary and secondary windings and the core are fully encapsulated under vacuum in cast resin.",
    specs: [
      { k: "Voltage class", v: "12 / 24 kV" },
      { k: "Types", v: "Current (CT) & Voltage (VT)" },
      { k: "Insulation", v: "Cast resin, vacuum-encapsulated" },
      { k: "Rated frequency", v: "50 Hz" },
      { k: "Standards", v: "IEC 61869" },
      { k: "Installation", v: "Indoor, metal-enclosed panels" },
    ],
    features: [
      "Accurate current and voltage measurement for metering and protection",
      ...
      "Engineered and tested to IEC 61869",
