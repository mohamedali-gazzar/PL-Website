...
export const aboutCopy = {
  ...
  body:
    "We build where we add real value — engineering, fabrication, integration, and service — and partner with the world's best for the rest. The result: high-quality power solutions, delivered on our word, at a price you can build on.",
  partnerStatement:
